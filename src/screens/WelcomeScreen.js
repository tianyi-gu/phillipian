...
export default function WelcomeScreen() {
  ...
  return (
    <View className="flex-1 justify-center items-center pb-6 bg-green-900">
      <LinearGradient
      ...
      <View className="flex-1 items-center justify-end max-w-[85%] space-y-4">
        ...
        <Text
          ...
          style={{
            fontSize: wp(SUBTITLE_FONT_SIZE),
